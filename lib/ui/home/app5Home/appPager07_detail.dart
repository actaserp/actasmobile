...
class AppPager07Detail extends StatefulWidget{
  ...
  const AppPager07Detail({Key? key, required this.e411Data}) : super(key: key);


  @override
  _AppPager07DetailState createState() => _AppPager07DetailState();

}

class _AppPager07DetailState extends State<AppPager07Detail> {
  ...
  void setData(){
    ...
    _etContnm = TextEditingController(text: widget.e411Data.contnm);
    _etContents = TextEditingController(text: widget.e411Data.contents);
