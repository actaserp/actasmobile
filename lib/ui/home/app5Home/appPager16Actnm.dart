...
class AppPager16Actnm extends StatefulWidget {

  final String data;

  AppPager16Actnm({required this.data});

  @override
  _AppPager16ActnmState createState() => _AppPager16ActnmState();
}


class _AppPager16ActnmState extends State<AppPager16Actnm> {
  ...
  Future getactnminfo() async {
    ...
    var uritxt = CLOUD_URL + '/apppgymobile/tbe601list_2';
            ...
            children: [
              TextButton(child: Text(e601Data.actnm, style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold)),
                onPressed: () {
                  ...
                  Navigator.pop(context, [e601Data.actcd, e601Data.actnm, e601Data.cltcd, e601Data.equpcd, e601Data.equpnm]);
                },
              ),
              Text('현장코드: ' + e601Data.actcd, style: GlobalStyle.couponName),
              Text('호기코드: ' + e601Data.equpcd, style: GlobalStyle.couponName),
              Text('호기명: ' + e601Data.equpnm, style: GlobalStyle.couponName),
