...
import 'appPager08_detail.dart';

class AppPager08 extends StatefulWidget {
  @override
  _AppPager08State createState() => _AppPager08State();
}

class _AppPager08State extends State<AppPager08> {
  TextEditingController _etSearch = TextEditingController();
  TextEditingController _etSearch2 = TextEditingController();
  List<e411list_model>  e411Data_2 = e411Data;
  bool chk = false;
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('고장부위별 현황' + e411Data_2.length.toString(),
          ...
          child: TextButton(
              onPressed: (){
                ...
                setState(() {
                  ...
                  if(_etSearch2.text == ""){
                    showAlertDialog(context, "고장부위을 입력하세요.");
                  }
                  e411list_getdata();
                });
        ...
        child: Column(
          children: [
            ...
            chk ? Expanded(
              ...
              child: ListView.builder(itemCount: e411Data_2.length,
                padding: EdgeInsets.fromLTRB(16, 0, 16, 16),
                physics: AlwaysScrollableScrollPhysics(),
                itemBuilder: (BuildContext context, int index){
                  return _buildListCard(e411Data_2[index]);
                },
              ),
            ) : Text("현장조회를 하십시오."),
  ...
  Widget _buildListCard(e411list_model e411Data){
    return Card(
      ...
      child: GestureDetector(
        ...
        onTap: (){
          Navigator.push(context, MaterialPageRoute(builder: (context) => AppPager08Detail(e411Data: e411Data)));
        },
        child: Container(
