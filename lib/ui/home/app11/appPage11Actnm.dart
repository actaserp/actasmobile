...
class AppPage11Actnm extends StatefulWidget {

  final String data;

  AppPage11Actnm({required this.data});

  @override
  _AppPage11ActnmState createState() => _AppPage11ActnmState();
}


class _AppPage11ActnmState extends State<AppPage11Actnm> {
 ...
 Future getactnminfo() async {
   ...
   var uritxt = CLOUD_URL + '/e038mbc/getActInfo';
           ...
           children: [
             TextButton(child: Text(e601Data.actnm, style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold)),
                 onPressed: () {
                   ...
                   Navigator.pop(context, [e601Data.actcd, e601Data.actnm]);
                 },
               ),
